...
public class Shoot extends Sprite {
	...
	public Shoot(PlayScreen screen, float x, float y, boolean fireRight){
        ...
        setBounds(x, y, 2 / SKGame.getPpm(), 2 / SKGame.getPpm());
        defineWeapon();
    }

	public void defineWeapon() {
		 BodyDef bdef = new BodyDef();
	        bdef.position.set(fireRight ? getX() + 6 / SKGame.getPpm() : getX() - 6 / SKGame.getPpm(), getY() +4/SKGame.getPpm());
	        ...
	        fdef.filter.categoryBits = SKGame.FIRESHOOT_BIT;
	 ...
	 public void update(float dt){
	        ...
	        if((stateTime > 0.5f || setToDestroy) && !destroyed) {
